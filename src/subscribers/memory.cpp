...
MemorySubscriber::MemorySubscriber( const std::string& name, const std::string& speech_topic, const qi::SessionPtr& session ):
...
{
  sub_speech_ = nh.subscribe( speech_topic_, 10, &MemorySubscriber::memory_callback, this );
